...
<div class="donacion">
  ...
  <p><a href="<?php echo $apg_free_shipping['paypal']; ?>" target="_blank" title="<?php _e('Make a donation by ', 'apg_free_shipping'); ?>PayPal"><span class="icon-paypal"></span></a></p>
  <div>
  ...
  <div>
    ...
    <p><a href="https://www.facebook.com/artprojectgroup" title="<?php _e('Follow us on ', 'apg_free_shipping'); ?>Facebook" target="_blank"><span class="icon-facebook6"></span></a> <a href="https://twitter.com/artprojectgroup" title="<?php _e('Follow us on ', 'apg_free_shipping'); ?>Twitter" target="_blank"><span class="icon-social19"></span></a> <a href="https://plus.google.com/+ArtProjectGroupES" title="<?php _e('Follow us on ', 'apg_free_shipping'); ?>Google+" target="_blank"><span class="icon-google16"></span></a> <a href="http://es.linkedin.com/in/artprojectgroup" title="<?php _e('Follow us on ', 'apg_free_shipping'); ?>LinkedIn" target="_blank"><span class="icon-logo"></span></a></p>
  </div>
  <div>
    <p>
      <?php _e('More plugins:', 'apg_free_shipping'); ?>
    </p>
    <p><a href="http://profiles.wordpress.org/artprojectgroup/" title="<?php _e('More plugins on ', 'apg_free_shipping'); ?>WordPress" target="_blank"><span class="icon-wordpress2"></span></a></p>
  </div>
  <div>
    <p>
      <?php _e('Contact with us:', 'apg_free_shipping'); ?>
    </p>
    <p><a href="mailto:info@artprojectgroup.es" title="<?php _e('Contact with us by ', 'apg_free_shipping'); ?>e-mail"><span class="icon-open21"></span></a> <a href="skype:artprojectgroup" title="<?php _e('Contact with us by ', 'apg_free_shipping'); ?>Skype"><span class="icon-social6"></span></a></p>
  </div>
  <div>
    <p>
      <?php _e('Documentation and Support:', 'apg_free_shipping'); ?>
    </p>
    <p><a href="<?php echo $apg_free_shipping['plugin_url']; ?>" title="<?php echo $apg_free_shipping['plugin']; ?>"><span class="icon-work"></span></a></p>
  </div>
  <div>
