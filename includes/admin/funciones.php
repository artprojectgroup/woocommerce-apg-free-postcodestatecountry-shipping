 ...
 * @return void
 */
function apg_free_shipping_borra_todos_los_transients_metodos_envio( $zone_id, $method_id, $instance_id ) {
...
add_action( 'woocommerce_shipping_zone_method_added', 'apg_free_shipping_borra_todos_los_transients_metodos_envio', 10, 3 );
