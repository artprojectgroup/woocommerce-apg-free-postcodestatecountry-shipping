...
<div class="cabecera"> <a href="<?php echo $apg_free_shipping[ 'plugin_url' ]; ?>" title="<?php echo $apg_free_shipping[ 'plugin' ]; ?>" target="_blank"><img src="<?php echo plugins_url( 'assets/images/cabecera.jpg', DIRECCION_apg_free_shipping ); ?>" class="imagen" alt="<?php echo $apg_free_shipping[ 'plugin' ]; ?>" /></a> </div>
